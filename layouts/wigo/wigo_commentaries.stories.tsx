...
import { WigoCommentaries } from "./wigo_commentaries";

export default {
   title: "Layouts/Wigo/Quotes Carrousel",
   component: WigoCommentaries
} as ComponentMeta<typeof WigoCommentaries>;

export const ThoughtPost: ComponentStory<typeof WigoCommentaries> = () => (
   <WigoCommentaries
      commentaries={[
         {
            ID: "32",
