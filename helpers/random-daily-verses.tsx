//type IreferencedScriptures = { id: string; chapter: { verse: number[] }[] };
...
export const randomVerses = [
   {
      ...
      verses: [
         ...
         67, 34, 35, 46, 22, 35, 43, 54, 33, 20, 31, 29, 43, 36, 30, 23, 23, 57, 38, 34, 34, 28, 34,
         31, 22, 33, 26
      ]
   },
   {
      ...
      chapters: 40,
      verses: [
         22, 25, 22, 31, 23, 30, 29, 28, 35, 29, 10, 51, 22, 31, 27, 36, 16, 27, 25, 26, 37, 30, 33,
